...
pub struct DefaultKeycloakSeeding<TManager: KeycloakManagement> {
    manager: Arc<TManager>,
}

impl<TManager: KeycloakManagement> DefaultKeycloakSeeding<TManager> {
    pub fn new(manager: Arc<TManager>) -> Self {
